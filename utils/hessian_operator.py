...
class HessianOperatorRealData():
    ## The difference here is boundary is able to be changed
    cgiter = 0
    def __init__(self, R, Wmm, C, A, adj_A, W, Wum, bc_adj, gauss_newton_approx=False):
        self.R = R
        self.Wmm = Wmm
    ...
    def mult_GaussNewton(self, v, y):
        ...
        # Reg/Prior term
        RpWmm = self.R # I think this is missing a Wmm but for some reason without it works better
        # RpWmm = self.apply_symm_bc_2_matrix(RpWmm)
        RpWmm.mult(v,y)
